...
import {  getJWTToken } from "@/app/actions/funcionario"
import OrcamentoPageClient from "./orcamento-client-page"
...
export default async function FuncionariosPage() {
  ...
  return <OrcamentoPageClient orcamentosIniciais={orcamentosResult} />
}
